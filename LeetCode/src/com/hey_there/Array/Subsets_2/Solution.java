package com.hey_there.Array.Subsets_2;
...
public class Solution {
    ...
    private List<List<Integer>> helper(int[] nums) {
        ...
        //递归计算子数组的子集
        List<List<Integer>> subsetsOfSubarray = subsetsWithDup(subarray);
